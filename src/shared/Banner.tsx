...
const Banner = () => {
  return (
    <Swiper pagination={{
      ...
      {(banner || []).map((item: any) => {
        return ( 
          <SwiperSlide className={`banner relative before:absolute before:z-[5] before:bottom-0 before:w-full xs:before:h-[100px] sm:before:h-[100px] lg:before:h-[170px]`} style={{backgroundColor: '#4d0202'}}>
